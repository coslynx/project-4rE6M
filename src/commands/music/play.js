...
/**
 * Handles the `play` command, playing music from YouTube, Spotify, or SoundCloud.
 *
 * @param {Client} client The Discord client instance.
 * @param {Discord.Message} message The message object that triggered the command.
 */
const playCommand = async (client, message) => {
  const searchQuery = message.content.slice(constants.PREFIX.length + 5); // Remove the command and space
